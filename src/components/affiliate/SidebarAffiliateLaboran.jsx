...
const Sidebar = ({ sidebarOpen, setSidebarOpen, activePage, setActivePage, onLogout }) => {
    ...
    const menuItems = [
        { icon: Users, label: 'Lab Affiliate', path: '/panel/portal/affiliate/laboran' },
        { icon: ClipboardList, label: 'Lab Affiliate', path: '/panel/portal/affiliate/laboran/catalog' },
        { icon: Settings, label: 'Lab Affiliate', path: '/panel/portal/affiliate/laboran/layanan_analisis' },
    ];
