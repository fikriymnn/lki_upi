                ...
                <div className="px-5 pb-5 ">
                    ...
                    <div className="flex flex-col gap-5 mt-5">
                        ...
                        <div>
                            ...
                            <h1 className="input-style-lki">{jenis_pengujian?jenis_pengujian:"-"}</h1>
                        </div>
                        <div>
                            <h1 className="md:text-lg text-xs sm:text-sm font-semibold text-grey-600">kode pengujian sample : </h1>
                            <h1 className="input-style-lki">{kode_pengujian?kode_pengujian:"-"}</h1>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <h1 className="input-style-lki-box ">{sample_dikembalikan?sample_dikembalikan:"-"}</h1>
                        </div>
                        <div>
