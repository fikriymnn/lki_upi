                        ...
                        <div className="m-auto w-10/12 border-2 rounded-lg flex flex-col justify-start items-start ">
                            ...
                            <div className="flex gap-5 w-62 mx-5  mt-10">
                                ...
                                <div>
                                    ...
                                    {invoice.status == "menunggu form dikonfirmasi" || invoice.status == "form dikonfirmasi" || invoice.status == "sample diterima admin" || invoice.status == "sample dikerjakan operator" || invoice.status == "menunggu verifikasi" || invoice.status == "menunggu pembayaran" || invoice.status == "menunggu konfirmasi pembayaran" || invoice.status == "selesai" ? <div className=""><p className="text-red-600 md:text-2xl sm:text-xl text-base font-semibold">Menunggu acc</p><p className=" text-xs text-red-600">{invoice.s1_date}</p></div> : <div className=""><p className="text-gray-400 md:text-2xl sm:text-xl text-base font-semibold">Menunggu acc</p></div>}
                                </div>
                            </div>
                            ...
                            <div className="flex gap-5 w-62 mx-5 ">
                                ...
                                <div>
                                    ...
                                    {invoice.status == "form dikonfirmasi" || invoice.status == "sample diterima admin" || invoice.status == "sample dikerjakan operator" || invoice.status == "menunggu verifikasi" || invoice.status == "menunggu pembayaran" || invoice.status == "menunggu konfirmasi pembayaran" || invoice.status == "selesai" ? <div className=""><p className="text-red-600 md:text-2xl sm:text-xl text-base font-semibold">Menunggu sample diterima oleh admin</p><p className=" text-xs text-red-600">{invoice.s2_date}</p></div> : <div className=""><p className="text-gray-400 md:text-2xl sm:text-xl text-base font-semibold">Menunggu sample diterima oleh admin</p></div>}
                                </div>
                            </div>
                            <div className="flex gap-5 w-62 mx-5">
                                ...
                                <div>
                                    ...
                                    {invoice.status == "sample diterima admin" || invoice.status == "sample dikerjakan operator" || invoice.status == "menunggu verifikasi" || invoice.status == "menunggu pembayaran" || invoice.status == "menunggu konfirmasi pembayaran" || invoice.status == "selesai" ? <div className=""><p className="text-red-600 md:text-2xl sm:text-xl text-base font-semibold">sample sedang dikirim ke operator</p><p className=" text-xs text-red-600">{invoice.s3_date}</p></div> : <div className=""><p className="text-gray-400 md:text-2xl sm:text-xl text-base font-semibold">Sedang dikirim ke operator </p></div>}
                                </div>
                            </div>
                            ...
                            <div className="flex gap-5 w-62 mx-5  ">
                                ...
                                <div>
                                    ...
                                    {invoice.status == "sample dikerjakan operator" || invoice.status == "menunggu verifikasi" || invoice.status == "menunggu pembayaran" || invoice.status == "menunggu konfirmasi pembayaran" || invoice.status == "selesai" ? <div className=""><p className="text-red-600 md:text-2xl sm:text-xl text-base font-semibold">sedang dikerjakan oleh operator</p><p className=" text-xs text-red-600">{invoice.s4_date}</p></div> : <div className=""><p className="text-gray-400 md:text-2xl sm:text-xl text-base font-semibold">Sedang dikerjakan oleh operator</p></div>}
                                </div>
                            </div>
                            <div className="flex gap-5 w-62 mx-5  ">
                                ...
                                <div>
                                    ...
                                    {invoice.status == "menunggu verifikasi" || invoice.status == "menunggu pembayaran" || invoice.status == "menunggu konfirmasi pembayaran" || invoice.status == "selesai" ? <div className=""><p className="text-red-600 md:text-2xl sm:text-xl text-base font-semibold">Menunggu verifikasi</p><p className=" text-xs text-red-600">{invoice.s5_date}</p></div> : <div className=""><p className="text-gray-400 md:text-2xl sm:text-xl text-base font-semibold">Menunggu verifikasi </p></div>}
                                </div>
                            </div>
                            <div className="flex gap-5 w-62 mx-5  ">
                                ...
                                <div>
                                    ...
                                    {invoice.status == "menunggu pembayaran" || invoice.status == "menunggu konfirmasi pembayaran" || invoice.status == "selesai" ? <div className=""><p className="text-red-600 md:text-2xl sm:text-xl text-base font-semibold">Menunggu pembayaran</p><p className=" text-xs text-red-600">{invoice.s6_date}</p></div> : <div className=""><p className="text-gray-400 md:text-2xl sm:text-xl text-base font-semibold">Menunggu pembayaran </p></div>}
                                </div>
                            </div>
                            <div className="flex gap-5 w-62 mx-5  ">
                                ...
                                <div>
                                    ...
                                    {invoice.status == "menunggu konfirmasi pembayaran" || invoice.status == "selesai" ? <div className=""><p className="text-red-600 md:text-2xl sm:text-xl text-base font-semibold">menunggu pembayaran dikonfirmasi</p><p className=" text-xs text-red-600">{invoice.s7_date}</p></div> : <div className=""><p className="text-gray-400 md:text-2xl sm:text-xl text-base font-semibold">menunggu pembayaran dikonfirmasi</p></div>}
                                </div>
                            </div>
                            <div className="flex gap-5 w-62 mx-5  ">
                                ...
                                <div>
                                    {invoice.status == "selesai" ? <div className=""><p className="text-red-600 md:text-2xl sm:text-xl text-base font-semibold">selesai</p><p className=" text-xs text-red-600">{invoice.s8_date}</p></div> : <div className=""><p className="text-gray-400 md:text-2xl sm:text-xl text-base font-semibold">selesai</p></div>}
                                </div>
                            </div>
