                        ...
                        <div className='px-10 py-5 flex flex-col gap-3'>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        e.preventDefault();
                                        lama_pengerjaan[0] = e.target.value;
                                    }}
                                >
                                    <option value="" selected>
                                        Pilih
                                    </option>
                                    { lama_pengerjaan[0] == "3 hari"?<option value="3 hari" selected>3 hari</option>:<option value="3 hari">3 hari</option>}
                                    {lama_pengerjaan[0]=="7 hari"?<option value="7 hari" selected>7 hari</option>:<option value="7 hari">7 hari</option>}
                                    {lama_pengerjaan[0]=="14 hari"?<option value="14 hari" selected>14 hari</option>:<option value="14 hari">14 hari</option>}
                                    {lama_pengerjaan[0]=="normal"?<option value="normal" selected>normal</option>:<option value="normal">normal</option>}
