                ...
                <div className="m-auto">
                    <div className="m-auto mx-40 border-2 rounded-lg">
                        ...
                        <div className="grid grid-cols-1">
                            {invoice.status == "menunggu form dikonfirmasi" || invoice.status == "form dikonfirmasi" || invoice.status == "sample diterima admin" || invoice.status == "sample dikerjakan operator" || invoice.status == "menunggu verifikasi" || invoice.status == "menunggu pembayaran" || invoice.status == "menunggu konfirmasi pembayaran" || invoice.status == "selesai"?<Image src={'/tracking/on/on1.png'}/>:<Image src={'/tracking/on/on1.png'}/>}
                        <div>
