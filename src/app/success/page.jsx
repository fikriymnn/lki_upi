export default function Success(){
    return(
        <>
          <div className="md:h-96 sm:h-96 h-64  m-auto flex align-center items-center justify-center">
          <center className="font-semibold md:text-2xl sm:text-xl text-lg w-7/12" >
