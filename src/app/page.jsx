        ...
        <div className="md:px-16 sm:px-16 px-10">
          <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 justify-items-center gap-6">
            ...
            <LayananCard
              ...
              href={"/sertifikasi"}
              selengkapnya={"Selengkapnya"}
              desc={"Laboratorium Kimia Instrumen UPI bekerja sama dengan Lembaga Tenaga Laboratorium Penguji (TELAPI) untuk Layanan Sertifikasi."}
            />
            <LayananCard
              title={"Pelatihan"}
              href={"/pelatihan"}
              selengkapnya={"Selengkapnya"}
              desc={"Laboratorium Kimia Instrumen UPI menyediakan Layanan Pelatihan."}
            />
          </div>
          <br /><br />
