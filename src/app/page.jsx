        ...
        <div className="md:px-16 sm:px-16 px-10">
          <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 justify-items-center gap-6">
            ...
            <LayananCard
              ...
              selengkapnya={"Selengkapnya"}
              desc={
                "Laboratorium Kimia Instrumen UPI bekerja sama dengan Lembaga Tenaga Laboratorium Penguji (TELAPI) untuk Layanan Sertifikasi."
              }
            />
            <LayananCard
              title={"Pelatihan"}
      ...
      <div className="bg-gray-200 py-10 w-full h-full md:px-16 sm:px-16 px-10">
        <div className="flex justify-center w-full md:flex-nowrap flex-wrap drop-shadow-lg">
          ...
          <div className="grid grid-cols-1 md:p-10 sm:p-5 p-2">
            <p className="md:text-5xl sm:text-3xl text-lg font-bold md:mb-100 sm:mb-8 mb-2 text-left">
              Tentang Kami
            </p>
            <p className="text-left drop-shadow-xl md:text-xl sm:text-lg text-sm">
              Laboratorium Kimia Instrumen (LKI) merupakan salah satu unit kerja
              di Prodi Kimia Universitas Pendidikan Indonesia. LKI membuka
              layanan untuk pengujian untuk dosen, mahasiswa, instansi, dan juga
              masyarakat umum.
            </p>
            <ButtonOrder />
          </div>
