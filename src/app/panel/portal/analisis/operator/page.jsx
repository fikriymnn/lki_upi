...
export default function MainPage() {
  ...
  const formatRole  = (role) => role ? role.charAt(0).toUpperCase() + role.slice(1) : 'Operator';
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto mt-16">
        ...
        {activePage === 'order-detail' && (
          <OrderDetail setActivePage={setActivePage} noInvoice={noInvoice} idInvoice={idInvoice} />
        )}
        {activePage === 'order-tracking' && (
          <OrderTracking setActivePage={setActivePage} noInvoice={noInvoice} idInvoice={idInvoice} />
        )}
      </main>
    </div>
  );
