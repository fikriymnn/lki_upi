...
import {
  ...
  ChevronLeft, Search, Wrench, DoorOpen, FlaskConical, Package, ClipboardList
} from 'lucide-react';
...
export default function AffiliateCatalog({ affiliateId }) {
  ...
  const activeCfg = activeJenis ? JENIS_CONFIG[activeJenis] : null;
  const ActiveIcon = activeCfg?.icon;
  const activeCls = activeCfg ? COLOR_CLASS[activeCfg.color] : null;
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      <p className="text-sm text-gray-500 mb-6 ml-12">
        Kelola katalog sewa alat, sewa lab, layanan analisis, dan pembelian bahan
      </p>
